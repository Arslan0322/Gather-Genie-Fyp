...
**Note: Ensure you run -lient before admin to properly configure socket.io connections.!**
**i.e: client on localhost:3000 and admin on localhost:3001**
...
5. Start the Server:
    To run the admin in development mode, use the following command:
    `npm start`
...
**Note: Ensure you run client before admin to properly configure socket.io connections.!**
**i.e: client on localhost:3000 and admin on localhost:3001**
